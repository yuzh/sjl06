...
class HsmFunctionTest(unittest.TestCase):
    ...
    def test_1E(self):
        # KEK clear=0123456789ABCDEF
        # KEK/MK   =1C0BE608104E8118
        # WK clear =0000000000000000
        # WK/MK    =AF5087BB215EECD5

        # normal
        req='1E'+'1'+'1'+'1C0BE608104E8118'+'1'+'AF5087BB215EECD5'
        print "req:%s"%(req)
        expect='1F00B4FD231647A5BEC08CA64DE9C1B123A7'
